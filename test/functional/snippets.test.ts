...
import { diagnosticSources, getDiagnosticsForDocument, testFolder, waitForParameterFilesChanged } from '../support/diagnostics';
    ...
    async function testSnippet(testCallbackContext: ITestCallbackContext, snippetsPath: string, snippetName: string, snippet: ISnippet): Promise<void> {
        ...
        try {
            ...
            if (tempTemplateFile) {
                ...
                await ext.deploymentFileMapping.getValue().mapParameterFile(tempTemplateFile.uri, undefined);
            }
        }
